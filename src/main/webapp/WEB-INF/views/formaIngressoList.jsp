        ...
        <div class="container">
            ...
            <div class="row clearfix">
                <div class="col-md-2 column margem">
                    <a type="button" class="btn btn-primary buttons hvr-bob sias-default" href="<c:url value="/controleFamiliar/formaIngresso/novo"/>">
                        ...
                        <tbody>
                            <c:if test="${not empty formaIngressoList}">
                                <c:forEach var="formaIngresso" items="${formaIngressoList}">
                                    <tr>
                                        <td>
                                            <a href="<c:url value="/controleFamiliar/formaIngresso/${formaIngresso.id}/editar"/>">
                                                ${formaIngresso.id}
                                            </a>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a href="<c:url value="/controleFamiliar/formaIngresso/${formaIngresso.id}/excluir"/>">
