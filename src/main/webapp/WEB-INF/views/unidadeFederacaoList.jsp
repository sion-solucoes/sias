...
<html>
    ...
    <body class="background-color title-margin">
        ...
        <div class="container">
            <h2>Listagem de Unidade Federação(UF)</h2>
            <hr>
            <div class="row clearfix">
                <div class="col-md-2 column margem">
                    <a type="button" class="btn btn-primary buttons hvr-bob sias-default" href="<c:url value="/cadastrosBasicos/unidadeFederacao/novo"/>">
                        ...
                        <tbody>
                            <c:if test="${not empty unidadeFederacaoList}">
                                <c:forEach var="unidadeFederacao" items="${unidadeFederacaoList}">
                                    <tr>
                                        <td>
                                            <a href="<c:url value="/cadastrosBasicos/unidadeFederacao/${unidadeFederacao.id}/editar"/>">
                                        ...
                                        <td>
                                            <a href="<c:url value="/cadastrosBasicos/unidadeFederacao/${unidadeFederacao.id}/excluir"/>">
