...
<html>
    ...
    <body class="background-color title-margin">
        ...
        <div class="container">
            <h2>Listagem de Condição de Ocupação</h2>
            <hr>
            <div class="row clearfix">
                <div class="col-md-2 column margem">
                    <a type="button" class="btn btn-primary buttons hvr-bob sias-default" href="<c:url value="/controleFamiliar/condicaoOcupacao/novo"/>">
                        ...
                        <tbody>
                            <c:if test="${not empty condicaoOcupacaoList}">
                                <c:forEach var="condicaoOcupacao" items="${condicaoOcupacaoList}">
                                    <tr>
                                        <td>
                                            <a href="<c:url value="/controleFamiliar/condicaoOcupacao/${condicaoOcupacao.id}/editar"/>">
