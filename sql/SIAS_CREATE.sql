 ...
 familia_data_inclusao timestamp without time zone NOT NULL DEFAULT now(), 
 familia_data_ultima_alteracao timestamp without time zone NOT NULL DEFAULT now(),
 ...
 familia_tipo_residencia varchar(255),
 familia_material_paredes_externas varchar(255),
 familia_acesso_energia_eletrica varchar(255),
 familia_agua_canalizada varchar(255),
 familia_forma_abastecimento_agua varchar(255),
 familia_escoamento_sanitario varchar(255),
 familia_coleta_lixo varchar(255),
 familia_numero_comodos smallint,
 familia_numero_dormitorios smallint,
 familia_acessibilidade varchar(255),
 familia_localizacao_area_risco varchar(255),
 familia_dificil_acesso_geografico varchar(255),
 familia_area_conflito_violencia varchar(255),
 familia_observacoes_condicoes_habitacionais varchar(255),
 ...
 familia_membro_data_inclusao timestamp without time zone NOT NULL DEFAULT now(), 
 familia_membro_data_ultima_alteracao timestamp without time zone NOT NULL DEFAULT now(),
 ...
 familia_membro_vitima_ameacas_discriminacao boolean NOT NULL,
 familia_membro_participa_grupos_religiosos boolean NOT NULL,
 familia_membro_participa_movimentos_sociais boolean NOT NULL,
 familia_membro_acesso_lazer boolean NOT NULL,
 familia_membro_companhia_adulto boolean NOT NULL,
 familia_membro_violencia_fisica boolean NOT NULL,
 familia_membro_violencia_psicologica boolean NOT NULL,
 familia_membro_exploracao_sexual boolean NOT NULL,
 familia_membro_abuso_violencia_sexual boolean NOT NULL,
 familia_membro_negligencia_abandono boolean NOT NULL,
 familia_membro_trabalho_infantil boolean NOT NULL,
 familia_membro_trajetoria_rua boolean NOT NULL,
 familia_membro_trafico_pessoas boolean NOT NULL,
 familia_membro_discriminacao_orientacao_sexual boolean NOT NULL,
 familia_membro_violencia_idoso_pcd boolean NOT NULL,
 familia_membro_acompanhamento varchar,
