                    ...
                    <div class="row clearfix">
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input placeholder="Código" maxlength="5" name="codigo" class="form-control sias-default" id="txtCodigo" value="${beneficioEventual.codigo}"/>    
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input placeholder="Descrição" maxlength="50" name="descricao" class="form-control sias-default" id="txtDescricao" value="${beneficioEventual.descricao}"/>    
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
