        ...
        <div class="container">
            ...
            <div class="row clearfix">
                <div class="col-md-2 column margem">
                    <a type="button" class="btn btn-primary buttons hvr-bob sias-default" href="<c:url value="/controleFamiliar/grauParentesco/novo"/>">
                        ...
                        <tbody>
                            <c:if test="${not empty grauParentescoList}">
                                <c:forEach var="grauParentesco" items="${grauParentescoList}">
                                    <tr>
                                        <td>
                                            <a href="<c:url value="/controleFamiliar/grauParentesco/${grauParentesco.id}/editar"/>">
