                    ...
                    <div class="row clearfix">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="Código" max="100" min="0" name="codigo" class="form-control sias-default" id="txtCodigo" value="${condicaoOcupacao.codigo}"/>    
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input placeholder="Descrição" maxlength="50" name="descricao" class="form-control sias-default" id="txtDescricao" value="${condicaoOcupacao.descricao}"/>    
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
